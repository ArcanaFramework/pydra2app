...
Pydra2App is a package for easily wrapping analysis pipelines to container images that
...
Pydra2App requires a recent version of Python (>=3.8) to run. So you may
...
install the extension module ``pydra2app-xnat``, e.g.
...
Pydra2App is licenced under the `Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International Public License <https://creativecommons.org/licenses/by-nc-sa/4.0/>`_
