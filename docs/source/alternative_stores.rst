...
create an issue for it in the `GitHub Issue Tracker <https://github.com/Australian-Imaging-Service/pipeline2app/issues>`__.
...
a reference implementation please see :class:`pipeline2app.file_system.data.SimpleStore`.

.. autoclass:: pipeline2app.core.store.Store
    :noindex:
