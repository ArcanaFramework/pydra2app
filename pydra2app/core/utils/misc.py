...
from pydra2app.core.exceptions import Pydra2AppUsageError, Pydra2AppError


logger = logging.getLogger("pydra2app")


PIPELINE_ANNOTATIONS = "__pydra2app_pipeline__"
CONVERTER_ANNOTATIONS = "__pydra2app_converter__"
SWICTH_ANNOTATIONS = "__pydra2app_switch__"
CHECK_ANNOTATIONS = "__pydra2app_check__"

ARCANA_SPEC = "__pydra2app_type__"
...
ARCANA_HOME_DIR = Path.home() / ".pydra2app"
...
def set_loggers(loglevel, pydra_level="warning", depend_level="warning"):
    """Sets loggers for pydra2app and pydra. To be used in CLI
    ...
    logging.getLogger("pydra2app").setLevel(parse(loglevel))
...
# Minimum version of Pydra2App that this version can read the serialisation from
