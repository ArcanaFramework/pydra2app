...
class App(Pydra2AppImage):
    ...
    def add_entrypoint(self, dockerfile: DockerRenderer, build_dir: Path):
        command_line = (
            self.command.activate_conda_cmd() + "pydra2app deploy pipeline-entrypoint"
        )
    ...
    def construct_dockerfile(self, build_dir: Path, **kwargs) -> DockerRenderer:
        ...
        build_dir : Path
            ...
            files to
        **kwargs
            Passed onto the Pydra2AppImage.construct_dockerfile() method
