...
to the AUTHORS file and the `__authors__` list in `pydra2app/__about__.py`.
...
using [pytest](https://docs.pytest.org/en/latest/), e.g. `pytest -vs pydra2app`
...
[link_Arcana]: https://github.com/australian-imaging-service/pydra2app
...
[link_zenodo]: https://github.com/australian-imaging-service/pydra2app/master/.zenodo.json
